...
class SettingHook(classLoader: ClassLoader) : BaseHook(classLoader) {
    ...
    override fun startHook() {
        ...
        // v9.1.0+: SplashActivity 可能已不存在，回退到 mainActivityClass
        (instance.splashActivityClass ?: instance.mainActivityClass)?.hookBeforeMethod("onCreate", Bundle::class.java) { param ->
