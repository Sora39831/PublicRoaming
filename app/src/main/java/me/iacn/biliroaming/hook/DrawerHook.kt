...
class DrawerHook(classLoader: ClassLoader) : BaseHook(classLoader) {
    ...
    override fun startHook() {
        ...
        // v9.1.0+: BaseMainFrameFragment 可能已改名，增加回退
        val baseMainFrameClass = "tv.danmaku.bili.ui.main2.basic.BaseMainFrameFragment".findClassOrNull(mClassLoader)
            ?: "tv.danmaku.bili.ui.main.basic.BaseMainFrameFragment".findClassOrNull(mClassLoader)
        baseMainFrameClass?.hookAfterMethod(
            "onViewCreated",
            View::class.java,
            Bundle::class.java
        ) { param ->
