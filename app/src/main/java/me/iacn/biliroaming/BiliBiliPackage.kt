...
class BiliBiliPackage constructor(private val mClassLoader: ClassLoader, mContext: Context) {
    ...
    val rxGeneralResponseClass by Weak {
        "com.bilibili.okretro.call.rxjava.RxGeneralResponse" from mClassLoader
            ?: "com.bilibili.okretro.call.rxjava3.RxGeneralResponse" from mClassLoader
    }
    ...
    val seasonParamsMapClass by Weak {
        "com.bilibili.bangumi.data.page.detail.BangumiDetailApiService\$UniformSeasonParamsMap" from mClassLoader
            ?: "com.bilibili.bangumi.data.page.detail.SeasonRepository\$UniformSeasonParamsMap" from mClassLoader
    }
    ...
    val splashActivityClass by Weak {
        "tv.danmaku.bili.ui.splash.SplashActivity" from mClassLoader
            ...
            ?: "tv.danmaku.bili.MainActivity" from mClassLoader
    }
    val mainActivityClass by Weak { "tv.danmaku.bili.MainActivityV2" from mClassLoader }
    val gripperBootExpClass by Weak {
        "com.bilibili.gripper.exp.a\$a" from mClassLoader
            ?: "com.bilibili.gripper.GripperExecute" from mClassLoader
    }
    ...
    val splashInfoClass by Weak {
        "tv.danmaku.bili.ui.splash.brand.BrandShowInfo" from mClassLoader
            ...
            ?: "tv.danmaku.bili.ui.splash.brand.model.BrandShowInfo\$a" from mClassLoader
    }
    ...
    val biliVideoDetailClass by Weak {
        ("tv.danmaku.bili.ui.video.api.BiliVideoDetail" from mClassLoader)
            ...
            ?: ("com.bapis.bilibili.app.view.v1.ViewUnite" from mClassLoader)
    }
    ...
    val commentInvalidFragmentClass by Weak {
        "com.bilibili.bangumi.ui.page.detail.OGVCommentFragment".from(mClassLoader)
            ?: "com.bilibili.bangumi.ui.page.detail.BangumiCommentInvalidFragmentV2"
                .from(mClassLoader)
            ?: "com.bilibili.bangumi.ui.page.detail.BangumiCommentInvalidFragment"
                .from(mClassLoader)
    }
    val playerQualityServiceClass by Weak {
        "com.bilibili.playerbizcommon.features.quality.PlayerQualityService" from mClassLoader
            ?: "com.bilibili.ship.theseus.united.page.videoquality.TheseusPlayerQualityService" from mClassLoader
    }
    ...
    // for v9.1.0+: 检测是否为 9.x 版本（部分类路径和逻辑发生变化）
    val isV9OrAbove by lazy { (clientVersionCode) >= 9000000 }
